...
<?php echo $this->Form->create('Commit');?>
	<fieldset>
		<legend><?php echo __('Edit Commit'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Commit.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Commit.id'))); ?></li>
