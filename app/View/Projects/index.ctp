<div class="projects index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Deploy'), array('controller'=>'prod_deployments', 'action' => 'add', $project['Project']['id']), null, __('Do you really want to deploy %s?', $project['Project']['title'])); ?>						
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
